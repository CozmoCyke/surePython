...
EXIT_CODE_BY_ERROR_CODE = {
    ...
    "DOCSTRING_REQUIRED": EXIT_REFUSED,
    "DOCSTRING_NOT_FOUND": EXIT_REFUSED,
    "DOCSTRING_MISMATCH": EXIT_REFUSED,
    "DOCSTRING_TARGET_UNSUPPORTED": EXIT_REFUSED,
    "DOCSTRING_INLINE_SUITE_UNSUPPORTED": EXIT_REFUSED,
    ...
    "PROJECT_MUTATION_LOCKED": EXIT_REFUSED,
    ...
    "PLAN_INVALID_JSON": EXIT_REFUSED,
    "PLAN_SCHEMA_UNSUPPORTED": EXIT_REFUSED,
    "PLAN_INVALID": EXIT_REFUSED,
    "PLAN_EMPTY": EXIT_REFUSED,
    "PLAN_TOO_LARGE": EXIT_REFUSED,
    "PLAN_DUPLICATE_STEP_ID": EXIT_REFUSED,
    "PLAN_OPERATION_UNSUPPORTED": EXIT_REFUSED,
    "PLAN_ARGUMENTS_INVALID": EXIT_REFUSED,
    "PLAN_FILE_NOT_FOUND": EXIT_REFUSED,
    "PLAN_PREVIEW_MISMATCH": EXIT_REFUSED,
    "PLAN_PREVIEW_HASH_REQUIRED": EXIT_REFUSED,
    "PLAN_STEP_FAILED": EXIT_REFUSED,
    "PLAN_NO_FINAL_CHANGES": EXIT_REFUSED,
    "PLAN_TESTS_FAILED": EXIT_TESTS_FAILED,
    "PLAN_DATABASE_FAILED": EXIT_INTERNAL,
    "PLAN_NOT_FOUND": EXIT_REFUSED,
    "PLAN_ALREADY_ROLLED_BACK": EXIT_REFUSED,
    "PLAN_ROLLBACK_FAILED": EXIT_REFUSED,
    "PLAN_RECOVERY_REQUIRED": EXIT_SECURITY,
    "PLAN_STATE_INVALID": EXIT_REFUSED,
    "PLAN_MANIFEST_INVALID": EXIT_SECURITY,
    "PLAN_RECOVERY_CONFLICT": EXIT_REFUSED,
