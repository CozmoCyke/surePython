...
@pytest.mark.parametrize(
    ...
    [
        ...
        ({"plan_schema_version": "1.0", "steps": [{"id": "step", "operation": "add-docstring", "file": "/abs/module_a.py", "arguments": {"symbol": "Service.greet", "docstring": "Greet a user."}}]}, "PLAN_FILE_NOT_FOUND"),
